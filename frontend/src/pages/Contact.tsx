...
export const Contact = () => {
  ...
  return (
    <div className="animate-in fade-in duration-700">
      <HeaderBanner
        title="Contact Us"
        subtitle="Reach out to our regional coordination team for mission support, strategic partnerships, or urgent inquiries."
        bgImage={bgContact}
          ...
          <div>
            ...
            <div className="space-y-8">
              <div className="flex gap-6 p-6 bg-slate-50 rounded-[2rem] border border-slate-100 transition-all hover:bg-white hover:shadow-xl">
                ...
                <div>
                  <h4 className="font-black text-slate-900 mb-1 text-lg">Office Locations</h4>
                  <p className="text-slate-500 font-bold leading-relaxed text-sm">
                    Kigali-Rwanda, Goma-DRC<br />
                    Bangui-RCA, Brazzaville-Congo
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6 p-6 bg-slate-50 rounded-[2rem] border border-slate-100 transition-all hover:bg-white hover:shadow-xl">
                ...
                <div>
                  ...
                  <p className="text-slate-500 font-bold leading-relaxed text-sm">apdfe19@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex gap-6 p-6 bg-slate-50 rounded-[2rem] border border-slate-100 transition-all hover:bg-white hover:shadow-xl">
                ...
                <div>
                  ...
                  <p className="text-slate-500 font-bold leading-relaxed text-sm">+250 788 219 724<br />+236 74 89 66 50</p>
                </div>
              </div>
