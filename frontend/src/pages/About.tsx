...
const TEAM_MEMBERS = [
  ...
  { id: 'onyimba', name: 'Mrs. Rosine MURENGO ONYIMBA', role: 'Projects Coordinator', location: 'Central African Republic', image: onyimba, bio: "Mrs. Rosine MURENGO ONYIMBA drives on-the-ground execution of APDFE's initiatives in the Central African Republic. She coordinates rapid response and long-term development projects, focusing on building resilient community structures and safe spaces that empower women and children impacted by conflict." },
  { id: 'mrs-projects', name: 'Mrs. Projects', role: 'Projects Coordinator', location: 'Eastern - DRC (North and South Kivu)', image: mrsProjects, bio: 'Coordinating projects across North and South Kivu in the Eastern DRC, she navigates one of the most challenging humanitarian landscapes to deliver critical protection, health, and resilience-building programs. She collaborates with local stakeholders to safeguard the rights of vulnerable populations amidst ongoing crises.' },
  { id: 'felix', name: 'Mr. MFIZI Felix Mutako', role: 'Projects Coordinator', location: 'Congo-Brazzaville', image: felix, bio: "Mr. MFIZI Felix Mutako coordinates APDFE's expanding footprint in Congo-Brazzaville. He focuses on fostering grassroots partnerships and driving community-led development initiatives that empower marginalized groups, ensuring that comprehensive support systems and educational programs are accessible to those who need them most." },
  { id: 'pacifique', name: 'Mr. BIGIRIMANA PACIFIQUE', role: 'Projects Coordinator', location: 'Rwanda', image: pacifique, bio: "Mr. BIGIRIMANA PACIFIQUE leads project coordination in Rwanda, streamlining the delivery of health and educational empowerment services. He is deeply committed to nurturing local talent and ensuring that APDFE's missions translate into practical, life-changing outcomes for women and children in the region." },
];
